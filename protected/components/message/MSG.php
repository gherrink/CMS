...
class MSG
{
	...
	/* EXEPTION */
	const EXEPTION_CONST_NOTDEFINED		= 'EXEPTION_CONST_NOTDEFINED';
	const EXEPTION_SITE_NOTFOUND		= 'EXEPTION_SITE_NOTFOUND';
	const EXEPTION_SITE_NOCONTENT		= 'EXEPTION_SITE_NOCONTENT';
	/*/EXEPTION */
	...
	/* QUESTION BUTTONS */
	const QUESTION_BTN_REALYCLOSE 			= 'QUESTION_BTN_REALYCLOSE';
	/*/QUESTION BUTTONS */
