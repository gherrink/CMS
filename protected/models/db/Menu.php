...
class Menu extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('menuid, languageid, label, url_intern, url, site, icon, parent_menuid, parent_languageid, update_userid, update_time, create_userid, create_time, roleaccess',
                'safe', 'on' => 'search'),
        );
    }
    ...
    public function validateParent($attribute, $params)
    {
        ...
        {
            $menu = Menu::model()->findByAttributes(array('menuid' => $this->parent_menuid,
                'languageid' => $this->parent_languageid));
            if ($menu === null)
    ...
    private static function getMenuItems($menus)
    {
        ...
        foreach ($menus as $menu)
        {
            ...
            if ($menu->url_intern)
            {
                ...
                {
                    $items[$counter]['url'] = Yii::app()->createAbsoluteUrl('site/read', array(
                        'name' => $menu->site));
                }
            }
...
// 							),
    ...
    public static function getMMenu($mmneu)
    {
        if ($mmneu)
            return array(
                'label' => MsgPicker::msg()->getMessage(MSG::MP_MODERATOR_MENU),
                'url' => Yii::app()->createAbsoluteUrl('menu/read', array(
