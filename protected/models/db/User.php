...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('password_repead', 'compare', 'compareAttribute'=>'password', 'on'=>'register'),
			array('mail', 'email', 'on'=>'register'),
			array('mail', 'unique', 'on'=>'register, mail'),
			array('verifyCode', 'captcha', 'allowEmpty'=>!CCaptcha::checkRequirements(), 'on'=>'register, mail'),
			array('userid, firstname, lastname, password, mail, mail_valid, active', 'safe', 'on'=>'search'),
		);
	}
