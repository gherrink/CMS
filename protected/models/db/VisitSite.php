...
/**
 * This is the model class for table "VisitSite".
 *
 * The followings are the available columns in table 'VisitSite':
...
class VisitSite extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('visitid, siteid, languageid, time', 'required'),
			array('visitid, siteid', 'length', 'max'=>32),
			array('languageid', 'length', 'max'=>2),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('visitid, siteid, languageid, time', 'safe', 'on'=>'search'),
		);
	}
