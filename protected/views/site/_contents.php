...
foreach ($contents as $content)
    $this->renderPartial('../content/_content', array('model' => $content,
        'edit' => $edit, 'editable' => false, 'site' => $site->siteid));

if ($edit)
{
    echo '<div id="newContent"></div>';
    $url = Yii::app()->createAbsoluteUrl('content/view', array('head' => MSG::HEAD_CONTENT_ADD2SITE));
    $addUrl = Yii::app()->createAbsoluteUrl('content/addContent2Site', array(
        'col' => $col, 'site' => $site->label, 'onSite' => true));
